unit Cep.Service.Strategy.ApiCep;
...
type
  TCepApiCepStrategy = class(TInterfacedObject, ICepConsultaStrategy)
  public
...
function TCepApiCepStrategy.Consultar(const ACep: string; Model: ICep): Boolean;
var
  Http: THttpClient;
  Resp: IHTTPResponse;
  Json: TJSONObject;
begin
  ...
  try
    Resp := Http.Get('https://cdn.apicep.com/file/apicep/' + ACep + '/json/');
